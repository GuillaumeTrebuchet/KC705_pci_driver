...
#
# Generated by Vivado on Tue Apr 05 22:18:35 +0200 2022
...
#    "pcie_test.srcs/utils_1/imports/synth_1/pcie_test.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/pcie_test.srcs/utils_1/imports/synth_1/pcie_test.dcp"]"\
  ]
  foreach ifile $files {
...
set file "synth_1/pcie_test.dcp"
...
# pcie_dma_controller2
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins pcie_dma_controller2_0/clk]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins pcie_dma_controller2_0/resetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins axi_pcie_0/REFCLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins util_ds_buf_0/IBUF_OUT]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins xlconstant_2/dout]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/pcie_test.srcs/utils_1/imports/synth_1/pcie_test.dcp" -objects $obj
