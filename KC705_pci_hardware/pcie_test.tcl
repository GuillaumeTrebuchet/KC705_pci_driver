...
#
# Generated by Vivado on Fri Apr 08 23:07:58 +0200 2022
...
# pcie_dma_controller2
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins pcie_dma_controller2_0/doutb]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins pcie_dma_controller2_0/clk]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports ext_reset_in_0] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net pcie_dma_controller2_0_addrb [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins pcie_dma_controller2_0/addrb]
  connect_bd_net -net pcie_dma_controller2_0_clkb [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins pcie_dma_controller2_0/clkb]
  connect_bd_net -net pcie_dma_controller2_0_dinb [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins pcie_dma_controller2_0/dinb]
  connect_bd_net -net pcie_dma_controller2_0_enb [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins pcie_dma_controller2_0/enb]
  connect_bd_net -net pcie_dma_controller2_0_leds [get_bd_ports leds_0] [get_bd_pins pcie_dma_controller2_0/leds]
  connect_bd_net -net pcie_dma_controller2_0_web [get_bd_pins blk_mem_gen_0/web] [get_bd_pins pcie_dma_controller2_0/web]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_pcie_0/INTX_MSI_Request] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_pcie_0/MSI_Vector_Num] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  assign_bd_address -offset 0xC0000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.7",
   "Default View_TopLeft":"-164,-183",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port pcie_7x_mgt_0 -pg 1 -lvl 6 -x 1530 -y 510 -defaultsOSRD
preplace port CLK_IN_D_0 -pg 1 -lvl 0 -x 0 -y 220 -defaultsOSRD
preplace port port-id_PCIE_PERST_LS -pg 1 -lvl 0 -x 0 -y 390 -defaultsOSRD
preplace port port-id_ext_reset_in_0 -pg 1 -lvl 0 -x 0 -y 370 -defaultsOSRD
preplace portBus leds_0 -pg 1 -lvl 6 -x 1530 -y 420 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 5 -x 1410 -y 290 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 4 -x 1090 -y 400 -defaultsOSRD
preplace inst axi_pcie_0 -pg 1 -lvl 3 -x 730 -y 580 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 360 -y 390 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 100 -y 450 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 2 -x 360 -y 650 -defaultsOSRD
preplace inst pcie_dma_controller2_0 -pg 1 -lvl 4 -x 1090 -y 160 -defaultsOSRD
preplace inst util_ds_buf_0 -pg 1 -lvl 2 -x 360 -y 220 -defaultsOSRD
preplace netloc axi_pcie_0_mmcm_lock 1 1 3 190 490 560J 430 900
preplace netloc blk_mem_gen_0_doutb 1 3 2 930 320 NJ
preplace netloc clk_wiz_0_clk_out1 1 3 1 920 130n
preplace netloc pcie_dma_controller2_0_addrb 1 4 1 1290 100n
preplace netloc pcie_dma_controller2_0_clkb 1 4 1 1300 80n
preplace netloc pcie_dma_controller2_0_dinb 1 4 1 1270 120n
preplace netloc pcie_dma_controller2_0_enb 1 4 1 1260 140n
preplace netloc pcie_dma_controller2_0_leds 1 4 2 NJ 60 1510J
preplace netloc pcie_dma_controller2_0_web 1 4 1 1250 160n
preplace netloc util_ds_buf_0_IBUF_OUT 1 2 1 550J 210n
preplace netloc util_vector_logic_0_Res 1 0 2 NJ 390 NJ
preplace netloc xlconstant_0_dout 1 1 2 180 590 NJ
preplace netloc xlconstant_1_dout 1 2 1 560J 610n
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 2 2 540 420 N
preplace netloc axi_pcie_0_axi_ctl_aclk_out 1 1 3 180 290 NJ 290 910
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 2 2 530J 150 N
preplace netloc ext_reset_in_0_1 1 0 2 NJ 370 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 4 1 1280 220n
preplace netloc axi_pcie_0_M_AXI 1 3 1 930 380n
preplace netloc axi_pcie_0_pcie_7x_mgt 1 3 3 NJ 510 NJ 510 NJ
preplace netloc CLK_IN_D_0_1 1 0 2 NJ 220 NJ
levelinfo -pg 1 0 100 360 730 1090 1410 1530
pagesize -pg 1 -db -bbox -sgen -170 0 1680 730
"
}
