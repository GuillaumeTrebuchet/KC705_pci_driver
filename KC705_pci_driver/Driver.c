...
#pragma alloc_text (PAGE, KC705pcidriverEvtDeviceAdd)
#pragma alloc_text (PAGE, KC705pcidriverEvtDriverContextCleanup)
#endif
...
--*/
{
    ...
    attributes.EvtCleanupCallback = KC705pcidriverEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           KC705pcidriverEvtDeviceAdd
                           );
...
NTSTATUS KC705pcidriverEvtDevicePrepareHardware(
...
VOID
KC705pcidriverEvtDriverContextCleanup(
